// 地图
(function() {
    var myChart = echarts.init(document.getElementsByClassName('plat')[0])
    var geoCoordMap = {
        '上海': [121.4648, 31.2891],
        '东莞': [113.8953, 22.901],
        '东营': [118.7073, 37.5513],
    ...
    // var HKData = [
    //     [{ name: '海口' }, { name: '青海', value: 100 }],
    //     [{ name: '海口' }, { name: '韶关', value: 100 }],
    // ];
    ...
    var color = ['#a6c84c', '#ffa022', '#46bee9', '1D9DFF']; //航线的颜色
    var series = [];
    [
        ['西安', XAData],
        ['西宁', XNData],
